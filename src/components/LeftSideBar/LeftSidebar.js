    ...
    return(
      <Drawer open={this.props.isLeftSidebarOpen}>
        ...
        <div className="MenuItems">
          ...
          <MenuItem primaryText="Sources" rightIcon={<ArrowDropRight />} />
          <MenuItem primaryText="Drivers" rightIcon={<ArrowDropRight />} />
          <MenuItem primaryText="Equipment" rightIcon={<ArrowDropRight />} />
          <Divider />
          ...
          <Divider />
          <MenuItem primaryText="Customer Dashboard" rightIcon={<ArrowDropRight />} />
          <MenuItem primaryText="Map" rightIcon={<ArrowDropRight />}/>
          <Divider />
